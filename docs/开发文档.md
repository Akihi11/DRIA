...
| **接口**                          | **功能**             |
| --------------------------------- | -------------------- |
| POST /api/upload                  | 上传CSV或Excel文件   |
| GET /api/files/{file_id}/channels | 获取文件中的通道信息 |
| DELETE /api/files/{file_id}       | 删除上传的文件       |
...
| **接口**                                    | **功能**                   |
| ------------------------------------------- | -------------------------- |
| POST /api/ai_report/dialogue                | **与AI对话，配置报表参数** |
| POST /api/ai_report/sessions                | 创建新的对话会话           |
| GET /api/ai_report/sessions/{session_id}    | 获取会话信息               |
| DELETE /api/ai_report/sessions/{session_id} | 删除会话                   |
...
| **接口**                              | **功能**                  |
| ------------------------------------- | ------------------------- |
| POST /api/reports/generate            | **根据配置生成Excel报表** |
| GET /api/reports/download/{report_id} | 下载生成的报表            |
| GET /api/reports/{report_id}/info     | 查看报表详细信息          |
| GET /api/reports                      | 列出所有报表              |
| DELETE /api/reports/{report_id}       | 删除报表                  |
| GET /api/reports/system/info          | 获取系统信息              |
